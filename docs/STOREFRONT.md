...
- Double-click **`dblclick`** toggles the card flip; single click pulses the mark. Back face shows brand copy + lane/shipping facts; tilt is disabled while flipped
